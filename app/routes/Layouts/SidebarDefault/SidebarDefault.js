...
export const SidebarDefault = () => (
    <Container>
        ...
        <p className="mb-5">
            Welcome to the <b>&quot;InnovaraShopix&quot;</b> Admin Dashboard Theme based on <a href="https://getbootstrap.com" className="text-primary" target="_blank" rel="noopener noreferrer">Bootstrap 4.x</a> version for React called&nbsp;
        ...
        <section className="mb-5">
            <h6>
                Other versions for &quot;InnovaraShopix&quot;:
            </h6>
            <ul className="pl-3">
                <li>
